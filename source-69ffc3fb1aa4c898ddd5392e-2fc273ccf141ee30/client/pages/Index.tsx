...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-br from-background to-secondary py-16 px-4 sm:py-24">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <p className="text-xl text-foreground opacity-90 mb-8 leading-relaxed">
            The real reason your skin isn't responding — and the 5-second dissolving strip
      ...
      <section className="py-16 px-4 sm:py-24 bg-card">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-foreground opacity-90 leading-relaxed text-lg">
            ...
            <p>
              And you've probably already tried collagen.
            </p>
            ...
            <p className="font-semibold">
              The worst part? You blamed yourself.
            </p>
            ...
            <div className="bg-secondary border border-border rounded-lg p-8 my-8">
              <p className="font-semibold mb-4">
                The moment collagen enters your stomach, hydrochloric acid and digestive enzymes — the
                same ones designed to break down proteins — begin dismantling it. Collagen is a protein. It
                gets taken apart.
              </p>

              <p className="mb-4">
                What survives isn't collagen anymore. It's a pool of generic amino acids that your body
                distributes to whatever it considers most urgent that day: energy, muscle repair, immune
                function. Your body has no mechanism to redirect those amino acids back to your skin, your
                hair, or your joints. There's no postal route. There's no guarantee.
              </p>

              <p>
                And for many women, the experience isn't just useless — it's physically painful. The bloating,
                the gas, the nausea that feels like IBS. You were suffering through a supplement that wasn't
                working. That ends here.
              </p>
            </div>
            ...
            <p>
              ...
              bloodstream. The liver processes and filters compounds entering from the digestive tract —
              dramatically reducing what ever makes it through.
            </p>

            <p>
              The result: most of what you've been paying for every month has been converted into generic
              fuel before it reaches your bloodstream. It never touched your skin.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6 text-foreground opacity-90 leading-relaxed text-lg">
              ...
              <p>
                ...
                tongue. The reason is simple: the mucosal lining of your mouth is one of the most permeable,
                vascularized tissues in your entire body. Compounds placed here absorb directly into the
                capillary network, drain into the internal jugular vein, and enter your bloodstream in seconds —
                completely bypassing the stomach, the small intestine, and the liver's first-pass metabolism.
              </p>
              ...
              <p>
                The supplement industry simply never applied it to collagen.
              </p>
          ...
          <div className="space-y-6 text-foreground opacity-90 leading-relaxed text-lg mt-12">
            <div className="bg-card border-2 border-primary rounded-2xl p-8 my-8">
              <h3 className="text-2xl font-bold text-foreground mb-4 font-serif">
                Melt delivers collagen the same way emergency heart medication enters the
                bloodstream.
              </h3>

              <p className="mb-4">
                Each strip dissolves on your tongue in under 10 seconds. The collagen peptides absorb directly
                through your oral mucosa and enter your systemic circulation as intact peptides — the same
                form they need to be in to reach your skin, your hair follicles, and your joints.
              </p>
            ...
            <p>
              ...
              1,000 Da peptides — and dramatically more than the larger peptides found in standard
              powders.
            </p>

            <p className="font-semibold">
              Melt uses micro-peptide collagen formulated at approximately 500 Daltons. That is the optimal
              size for mucosal penetration. Not the highest dose. The right dose, delivered the right way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:py-24 bg-card">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-foreground opacity-90 mb-12">
            Melt is built on two independently published bodies of research. We're not asking you to take
            our word for it — we're asking you to read the studies.
          </p>

          <div className="space-y-8">
            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl font-bold text-foreground mb-2 font-serif">
                On buccal collagen delivery:
              </h3>
              <p className="text-foreground opacity-90 leading-relaxed">
                A peer-reviewed clinical trial published in <span className="italic">Applied Sciences</span> (MDPI, 2021) tested dissolvable collagen delivery films on the oral mucosa. The result:
                <span className="font-semibold"> statistically significant improvements in skin hydration and elasticity within 14 days.</span> Not 12
                weeks. Not "you might notice something." Measured. Statistically significant. 14 days.{' '}
            ...
            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl font-bold text-foreground mb-2 font-serif">
                On the 500 Dalton advantage:
              </h3>
              <p className="text-foreground opacity-90 leading-relaxed">
                Research published in the <span className="italic">Journal of Food Hygiene and Safety</span>{' '}
                compared collagen absorption rates at different molecular weights across oral mucosal tissue
                models. Collagen peptides at 500 Daltons absorbed at approximately 3x the rate of 1,000 Da
                peptides — and dramatically outperformed the 2,000–5,000 Da peptides found in standard
                commercial powders. Melt is formulated at approximately 500 Daltons.{' '}
                <a href="#" className="text-primary font-semibold hover:underline">
                  Read the study →
                </a>
              </p>
          ...
          <div className="bg-secondary border border-border rounded-2xl p-8 mt-12">
            ...
            <p className="text-foreground opacity-90 leading-relaxed mb-4">
              Melt is new. We don't have hundreds of reviews yet — because this technology is new, and the
              women who understand why it works are the early ones.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              If you're the kind of person who researches before she buys, who's been burned by marketing
              claims before, who wants to understand the mechanism before trusting a product — you're
      ...
      <section className="py-16 px-4 sm:py-24 bg-background">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-2xl text-foreground font-semibold mb-12">
            One strip. Five seconds. That's it.
          </p>

          <div className="bg-card rounded-2xl p-8 mb-12 border border-border">
            <div className="space-y-4 mb-8">
              <p className="text-foreground opacity-90 leading-relaxed">
                Peel it. Place it on your tongue. Let it dissolve.
              </p>
              <p className="text-foreground opacity-90 leading-relaxed font-semibold">
                No blender. No measuring spoon. No chalky aftertaste. No bloating. No cow smell. No prep. No
                cleanup. No routine to build or break.
              </p>
              <p className="text-foreground opacity-90 leading-relaxed">
          ...
          <div className="bg-card rounded-2xl p-8 border border-border">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex gap-4 text-foreground opacity-90">
                ...
                <span>
                  <span className="font-semibold">Hydrolyzed collagen micro-peptides (≈500 Dalton</span> — optimal for mucosal absorption)
                </span>
              </li>
              <li className="flex gap-4 text-foreground opacity-90">
                <Check size={24} className="text-accent flex-shrink-0 mt-1" />
                <span>
                  <span className="font-semibold">Vitamin C</span> — collagen synthesis requires it; without it, even delivered collagen can't do
                  its job
                </span>
              </li>
              <li className="flex gap-4 text-foreground opacity-90">
                <Check size={24} className="text-accent flex-shrink-0 mt-1" />
                <span>
                  <span className="font-semibold">Clean, simple ingredients.</span> No sucralose. No artificial fillers. No heavy metals. Nothing
            ...
            <ul className="space-y-2 text-foreground opacity-90 mb-8">
              ...
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 bg-primary rounded-full" />
                Mango flavor — actually pleasant. Not "flavored supplement" pleasant. Actually pleasant.
              </li>
            </ul>

            <p className="text-foreground opacity-90 leading-relaxed font-semibold">
              Works anywhere: In bed before you get up. In the car. At your desk. Before a flight. There is
              nothing to forget. Nothing to prepare. Nothing to clean up.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:py-24 bg-card">
        <div className="max-w-4xl mx-auto">
            ...
            {[
              {
                step: "1",
                title: "Peel",
                description: "Open your Melt tin and peel one strip from the packaging.",
              },
              {
                step: "2",
                title: "Place",
                description: "Put the strip on your tongue. It starts dissolving the moment it makes contact.",
              },
              {
                step: "3",
                title: "Done",
                description: "In under 10 seconds, it's gone.",
              },
            ].map((item) => (
          ...
          <div className="mt-12 bg-secondary rounded-2xl p-8 border border-border">
            <p className="text-foreground opacity-90 leading-relaxed">
              While you go on with your morning, collagen peptides are already in your bloodstream — not
              sitting in your stomach, getting destroyed. That's the entire difference between Melt and
              everything you've tried before.
            </p>
            <p className="text-foreground opacity-90 leading-relaxed font-semibold mt-4">
              No water. No prep. No waiting.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:py-24 bg-background">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-foreground opacity-90 mb-12 leading-relaxed">
            Most collagen brands ask you to wait 8–12 weeks before deciding if it works. That's because
            most of the collagen is being destroyed in digestion — so it takes enormous volume and time
            before anything meaningful gets through.
          </p>

          <div className="bg-card rounded-2xl p-8 border border-border mb-8">
            <p className="text-lg text-foreground font-semibold mb-4">
              Melt absorbs directly. The timeline is shorter.
            </p>
            <p className="text-foreground opacity-90 leading-relaxed">
              A peer-reviewed clinical study published in <span className="italic">Applied Sciences</span> (MDPI, 2021) on buccal collagen
              delivery films demonstrated <span className="font-semibold">statistically significant improvements in skin hydration and elasticity
              in just 14 days.</span>
            </p>
            <p className="text-foreground opacity-90 leading-relaxed font-bold mt-4">
              Not 12 weeks. 14 days.
            </p>
          </div>

          <div className="space-y-6">
            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl font-bold text-foreground mb-2 font-serif">Week 1–2:</h3>
              <p className="text-foreground opacity-90">
                Skin begins feeling more hydrated. Some women notice this as early as Day 5. The
                process has started.
              </p>
            </div>

            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl font-bold text-foreground mb-2 font-serif">Week 3–4:</h3>
              <p className="text-foreground opacity-90">
                Skin feels smoother to the touch. This is usually when someone in your life asks
                what you've been doing differently.
              </p>
            </div>

            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl font-bold text-foreground mb-2 font-serif">Week 6–8:</h3>
              <p className="text-foreground opacity-90">
                Hair thickness, nail strength, and skin elasticity are showing visible changes. This is
                when the women who tried to stay skeptical stop trying.
              </p>
            </div>
          </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-secondary">
                  ...
                  <th className="border border-border p-4 text-left font-bold text-foreground bg-primary bg-opacity-10">
                    Melt Strips
                  </th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  { label: "No bloating or GI issues", values: ["No — often causes", "No — often causes", "No — often causes", "Yes"] },
                  ...
                  <tr key={idx} className={idx % 2 === 0 ? "bg-card" : "bg-secondary bg-opacity-50"}>
                    ...
                    <td className="border border-border p-4 font-semibold text-foreground bg-primary bg-opacity-10">
                      {row.values[3]}
                    </td>
                  </tr>
                ))}
            ...
            {[
              {
                ...
                a: "We know. You've heard \"clinically proven,\" \"10,000mg,\" \"grass-fed,\" \"marine collagen\" — and you've tried it. The difference here isn't the ingredient. It's the delivery pathway. Mucosal absorption is not a marketing claim. It's the same mechanism doctors have used for 50 years to deliver emergency heart medication directly into the bloodstream. The biology isn't new. Applying it to collagen is.",
              },
              {
                id: "q2",
                q: "It's too expensive. I can get a huge tub of powder for less.",
                a: "A $45 tub that delivers 15–20% of its stated dose is more expensive per unit of actual absorption than a $45 box of Melt that delivers intact peptides directly to your bloodstream. You're not paying for more collagen. You're paying for collagen that actually gets in. That math changes everything.",
              },
              {
                id: "q3",
                q: "I've tried collagen before and it didn't work for me.",
                a: "That's exactly why Melt exists. Your previous collagen didn't fail because of you or your body. It failed because stomach acid destroyed it before it had a chance to reach your skin. That's chemistry, not genetics. Change the delivery format and you change the result.",
              },
              {
                id: "q4",
                q: "I don't know if the science is real.",
                a: "The mucosal absorption pathway is the basis for emergency heart medication, sublingual hormone therapy, and a range of high-bioavailability pharmaceuticals. It has been clinically validated for decades. A 2021 peer-reviewed study in Applied Sciences (MDPI) specifically tested buccal collagen delivery and found statistically significant improvements in skin hydration and elasticity within 14 days. You can read the study. We link to it.",
              },
              {
                id: "q5",
                q: "One strip a day seems like not enough.",
                a: "Dose is not the point. Delivery efficiency is. 100mg of collagen absorbed intact through your oral mucosa reaches your skin. 10,000mg destroyed by stomach acid does not. Melt uses peptides at approximately 500 Daltons — the optimal size for mucosal penetration — because getting the dose in matters more than making the number on the label look impressive.",
              },
              {
                id: "q6",
                q: "What if it doesn't work and I've wasted my money?",
                a: "You won't have. Every Melt order comes with a 30-day money-back guarantee. If you try it for 30 days and don't notice a change in your skin hydration, hair, nails, or how you feel — email us. We refund everything. No forms. No lengthy process. No \"let us look into it.\" You've already spent money on collagen that didn't work. This time, you have nothing to lose.",
              },
              {
                id: "q7",
                q: "Will it taste weird?",
                a: "No. Mango flavored and genuinely pleasant. No chalky aftertaste. No cow smell. No thick texture. It dissolves in seconds and leaves nothing behind.",
              },
            ].map((item) => (
      ...
      <section className="py-16 px-4 sm:py-24 bg-card">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-accent bg-opacity-10 border-2 border-accent rounded-2xl p-8">
            ...
            <p className="text-lg text-foreground opacity-90 leading-relaxed mb-6">
              Try Melt for 30 days. If you don't notice a difference — in your skin hydration, your hair, your
              nails, or how you feel — email us within 30 days of delivery. We'll refund every cent. No forms to
              fill out. No lengthy process. No questions asked.
            </p>

            <p className="text-lg font-semibold text-foreground">
              You've already spent money on collagen that didn't work. This time, if it doesn't deliver, the risk
              is ours. Not yours.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:py-24 bg-gradient-to-br from-primary to-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg leading-relaxed mb-12">
            <p>
              You're the one whose dermatologist notices the change and asks what you did.
            </p>
            <p>
              You're the one whose friend pulls her aside at dinner and says "your skin looks incredible —
              what are you using?"
            </p>
            <p>
              You're the one who stopped blaming herself for collagen that was never going to work — and
              started blaming the right thing: the format.
            </p>
            <p className="font-semibold text-xl">
              You've been waiting for something that actually gets in.
            </p>
      ...
      {/* Footer */}
      <footer className="bg-foreground text-primary-foreground text-opacity-70 py-12 px-4">
        <div className="max-w-6xl mx-auto">
